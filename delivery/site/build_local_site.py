...
from delivery.index.generate_mcp_snapshot import publish_snapshot
from runtime.v8std_mcp_snapshot_format import normalize_site_url
...
def build_local_site(root: Path, output: Path, site_url: str, source_sha: str) -> Path:
    ...
    if output == root or output in root.parents or any(
            ...
            for name in ("docs", "scripts", "runtime", "delivery", "dev", "data", "overrides", "site", "spec", "LICENSES")):
