...
Модуль fitness ещё должен быть создан при реализации. Его декларация в этом
candidate-пакете не является результатом теста или свидетельством IMPLEMENTED.
