...
implements:
  ...
  - contract:DIAGNOSTIC_RELATION_GRAPH@1.0
---
...
- [x] **Step 3: Implement the minimal clause model**
...
- [x] **Step 4: Render progressive semantic markup**
...
- [x] **Step 1: Write failing static behavior tests**
...
- [x] **Step 1: Add failing markup contract assertions**
...
- [x] **Step 1: Regenerate the registry**
