---
title: "ADR-0002: Безопасная аналитика и редизайн мониторинга MCP"
hide:
  - navigation
  - toc
  - feedback
...
# ADR-0002: Безопасная аналитика и редизайн мониторинга MCP

- Статус: принято
- Дата: 2026-08-14
- Область: MCP v2, MCP v3 и сайт `https://ai.v8std.ru/monitoring/`
- Связанные решения: ADR-0001, ADR-0003
