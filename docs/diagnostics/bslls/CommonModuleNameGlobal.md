...
- [#std469, п. 3.2.1: Правила создания общих модулей](../../std/469.md#321) — Диагностика «Пропущен постфикс "Глобальный" (CommonModuleNameGlobal)» проверяет условие пункта 3.2.1 стандарта std469.
