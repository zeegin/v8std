...
- [#std542, п. 4: Доступ к файловой системе из кода конфигурации](../../std/542.md#4) — Диагностика «Отсутствует удаление временного файла после использования (MissingTemporaryFileDeletion)» проверяет условие пункта 4 стандарта std542.
