...
- [#std469, п. 3.2.2: Правила создания общих модулей](../../std/469.md#322) — Диагностика «Пропущен постфикс "ПолныеПрава" (CommonModuleNameFullAccess)» проверяет условие пункта 3.2.2 стандарта std469.
