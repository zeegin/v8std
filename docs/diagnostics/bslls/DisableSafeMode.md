...
- [#std669, п. 3.2: Ограничение на выполнение внешнего кода](../../std/669.md#32) — Диагностика «Отключение безопасного режима (DisableSafeMode)» проверяет условие пункта 3.2 стандарта std669.
