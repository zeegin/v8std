...
- [#std418: Ограничение на использование метода Сообщить](../../std/418.md#std418) — Диагностика «Ограничение на использование устаревшего метода "Сообщить" (DeprecatedMessage)» проверяет требование всего std418; стандарт не имеет нумерованных пунктов.
