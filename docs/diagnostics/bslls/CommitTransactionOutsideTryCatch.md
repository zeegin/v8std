...
- [#std783, п. 1.3: Транзакции: правила использования](../../std/783.md#13) — Диагностика «Нарушение правил работы с транзакциями для метода 'ЗафиксироватьТранзакцию' (CommitTransactionOutsideTryCatch)» проверяет условие пункта 1.3 стандарта std783.
