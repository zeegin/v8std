...
- [#std439, п. 3: Использование директив компиляции и инструкций препроцессора](../../std/439.md#3) — Диагностика «Ошибка разбора исходного кода (ParseError)» проверяет условие пункта 3 стандарта std439.
