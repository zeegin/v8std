...
- [#std655, п. 1.1: Ограничения на соединения с вложенными запросами и виртуальными таблицами](../../std/655.md#11) — Диагностика «Соединение с вложенными запросами (JoinWithSubQuery)» проверяет условие пункта 1.1 стандарта std655.
