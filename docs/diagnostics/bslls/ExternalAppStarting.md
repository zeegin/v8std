...
- [#std774, п. 1: Безопасность запуска приложений](../../std/774.md#1) — Диагностика «Запуск внешних приложений (ExternalAppStarting)» проверяет условие пункта 1 стандарта std774.
