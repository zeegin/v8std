...
- [#std412, п. 1.1: Упорядочивание результатов запроса](../../std/412.md#11) — Диагностика «Использование 'ВЫБРАТЬ ПЕРВЫЕ' без 'УПОРЯДОЧИТЬ ПО' (SelectTopWithoutOrderBy)» проверяет условие пункта 1.1 стандарта std412.
