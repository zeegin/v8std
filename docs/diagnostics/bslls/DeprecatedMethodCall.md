...
- [#std453, п. 5.7: Описание процедур и функций](../../std/453.md#57) — Диагностика «Устаревшие методы не должны использоваться (DeprecatedMethodCall)» проверяет условие пункта 5.7 стандарта std453. Примечание: Пункт 5.7 задаёт конвенцию Устарела/Deprecated; запрет вызова является защитным расширением диагностики.
