...
- [#std467, п. 1.4: Общие требования к конфигурации](../../std/467.md#14) — Диагностика «Поддержка обычного приложения (OrdinaryAppSupport)» проверяет условие пункта 1.4 стандарта std467.
