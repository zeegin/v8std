...
- [#std640, п. 7: Параметры процедур и функций](../../std/640.md#7) — Диагностика «Пропущен обязательный параметр метода (MissedRequiredParameter)» проверяет условие пункта 7 стандарта std640.
