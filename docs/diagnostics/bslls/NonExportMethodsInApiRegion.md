...
- [#std455, п. 1.4: Структура модуля](../../std/455.md#14) — Диагностика «Неэкспортные методы в областях ПрограммныйИнтерфейс и СлужебныйПрограммныйИнтерфейс (NonExportMethodsInApiRegion)» проверяет условие пункта 1.4 стандарта std455.
