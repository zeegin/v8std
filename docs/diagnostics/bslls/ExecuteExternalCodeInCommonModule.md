...
- [#std770, п. 3: Ограничения на использование Выполнить и Вычислить на сервере](../../std/770.md#3) — Диагностика «Выполнение произвольного кода в общем модуле на сервере (ExecuteExternalCodeInCommonModule)» проверяет условие пункта 3 стандарта std770.
