...
- [#std435, п. 1.1: Ограничение на использование конструкции "ПОЛНОЕ ВНЕШНЕЕ СОЕДИНЕНИЕ" в запросах](../../std/435.md#11) — Диагностика «Использование конструкции "ПОЛНОЕ ВНЕШНЕЕ СОЕДИНЕНИЕ" в запросах (FullOuterJoinQuery)» проверяет условие пункта 1.1 стандарта std435.
