...
| [CodeBlockBeforeSub](CodeBlockBeforeSub.md) | Ошибка | Блокирующий | — |
...
| [CommandModuleExportMethods](CommandModuleExportMethods.md) | Дефект кода | Информационный | — |
| [CommentedCode](CommentedCode.md) | Дефект кода | Незначительный | — |
| [CommitTransactionOutsideTryCatch](CommitTransactionOutsideTryCatch.md) | Ошибка | Важный | — |
...
| [DeprecatedCurrentDate](DeprecatedCurrentDate.md) | Ошибка | Важный | — |
...
| [ExternalAppStarting](ExternalAppStarting.md) | Потенциальная уязвимость | Важный | — |
...
| [GetFormMethod](GetFormMethod.md) | Ошибка | Важный | — |
...
| [IncorrectUseLikeInQuery](IncorrectUseLikeInQuery.md) | Ошибка | Важный | — |
...
| [LogicalOrInJoinQuerySection](LogicalOrInJoinQuerySection.md) | Дефект кода | Важный | — |
| [LogicalOrInTheWhereSectionOfQuery](LogicalOrInTheWhereSectionOfQuery.md) | Дефект кода | Важный | — |
...
| [QueryNestedFieldsByDot](QueryNestedFieldsByDot.md) | Дефект кода | Важный | — |
...
| [RefOveruse](RefOveruse.md) | Дефект кода | Важный | — |
...
| [SetPermissionsForNewObjects](SetPermissionsForNewObjects.md) | Уязвимость | Критичный | — |
...
| [UsingGoto](UsingGoto.md) | Дефект кода | Критичный | — |
...
| [UsingModalWindows](UsingModalWindows.md) | Дефект кода | Важный | — |
...
| [UsingSynchronousCalls](UsingSynchronousCalls.md) | Дефект кода | Важный | — |
