...
- [#std640, п. 5: Параметры процедур и функций](../../std/640.md#5) — Диагностика «Ограничение на количество параметров метода (NumberOfParams)» проверяет условие пункта 5 стандарта std640.
