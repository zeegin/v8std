...
- [#std498, п. 2.2: Использование Журнала регистрации](../../std/498.md#22) — Диагностика «Неверное использование метода "ЗаписьЖурналаРегистрации" (UsageWriteLogEvent)» проверяет условие пункта 2.2 стандарта std498.
- [#std498, п. 2.3: Использование Журнала регистрации](../../std/498.md#23) — Диагностика «Неверное использование метода "ЗаписьЖурналаРегистрации" (UsageWriteLogEvent)» проверяет условие пункта 2.3 стандарта std498.
- [#std499, п. 2.2: Перехват исключений в коде](../../std/499.md#22) — Диагностика «Неверное использование метода "ЗаписьЖурналаРегистрации" (UsageWriteLogEvent)» проверяет условие пункта 2.2 стандарта std499.
