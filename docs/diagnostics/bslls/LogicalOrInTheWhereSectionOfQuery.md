###### bslls:LogicalOrInTheWhereSectionOfQuery
...
- Теги: `sql`, `performance`, `standard`

<!-- diagnostic-source:start
source_url=https://github.com/1c-syntax/bsl-language-server/blob/f4616cda8a216789ee40529ed857e614b9e2ea25/docs/diagnostics/LogicalOrInTheWhereSectionOfQuery.md
source_path=docs/diagnostics/LogicalOrInTheWhereSectionOfQuery.md
revision=f4616cda8a216789ee40529ed857e614b9e2ea25
SPDX-License-Identifier: LGPL-3.0-or-later
sha256=0d26c1b1187204b66352b243d0a8612ff50a18cf83e111f5f71c8550140cfe5f
-->
...
- [#std658, п. 2.1: Эффективные условия запросов](../../std/658.md#21) — Диагностика «Использование логического "ИЛИ" в секции "ГДЕ" запроса (LogicalOrInTheWhereSectionOfQuery)» проверяет условие пункта 2.1 стандарта std658. Примечание: Текущая реализация шире пункта 2.1 и может срабатывать на допустимые ИЛИ; статья диагностики явно предупреждает о ложных срабатываниях.
<!-- diagnostic-standards:end -->

## Источник диагностики

- [Исходная статья](https://github.com/1c-syntax/bsl-language-server/blob/f4616cda8a216789ee40529ed857e614b9e2ea25/docs/diagnostics/LogicalOrInTheWhereSectionOfQuery.md)
