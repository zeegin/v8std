...
- [#std467, п. 1.3: Общие требования к конфигурации](../../std/467.md#13) — Диагностика «У полей формы не указан путь к данным (WrongDataPathForFormElements)» проверяет условие пункта 1.3 стандарта std467.
