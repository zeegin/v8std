###### bslls:MissingTempStorageDeletion
...
- Теги: `standard`, `performance`, `badpractice`

<!-- diagnostic-source:start
source_url=https://github.com/1c-syntax/bsl-language-server/blob/f4616cda8a216789ee40529ed857e614b9e2ea25/docs/diagnostics/MissingTempStorageDeletion.md
source_path=docs/diagnostics/MissingTempStorageDeletion.md
revision=f4616cda8a216789ee40529ed857e614b9e2ea25
SPDX-License-Identifier: LGPL-3.0-or-later
sha256=acde0899bae3625452194f9396d5fc960d95478ff66d3c88e16ff4bbfa3a4838
-->
...
- [#std487, п. 8.3: Минимизация количества серверных вызовов и трафика](../../std/487.md#83) — Диагностика «Отсутствует удаление данных из временного хранилища после использования (MissingTempStorageDeletion)» проверяет условие пункта 8.3 стандарта std487. Примечание: Upstream называет устаревший пункт 7.3; в текущем тексте правило очистки находится в пункте 8.3.
- [#std642, п. 3.1: Длительные операции на сервере](../../std/642.md#31) — Диагностика «Отсутствует удаление данных из временного хранилища после использования (MissingTempStorageDeletion)» проверяет условие пункта 3.1 стандарта std642.
<!-- diagnostic-standards:end -->

## Источник диагностики

- [Исходная статья](https://github.com/1c-syntax/bsl-language-server/blob/f4616cda8a216789ee40529ed857e614b9e2ea25/docs/diagnostics/MissingTempStorageDeletion.md)
