...
- [#std542, п. 1: Доступ к файловой системе из кода конфигурации](../../std/542.md#1) — Диагностика «Доступ к файловой системе (FileSystemAccess)» проверяет условие пункта 1 стандарта std542.
