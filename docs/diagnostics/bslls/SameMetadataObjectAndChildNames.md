...
- [#std474, п. 2.4: Имя, синоним, комментарий](../../std/474.md#24) — Диагностика «Совпадает имя объекта метаданного и его дочернего (SameMetadataObjectAndChildNames)» проверяет условие пункта 2.4 стандарта std474.
