...
- [#std679, п. 1: Ограничение на установку признака «Вызов сервера» у общих модулей](../../std/679.md#1) — Диагностика v8cs:common-module-server-call проверяет требование пункта 1 стандарта std679.
