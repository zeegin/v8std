...
- [#std737, п. 3: Проверка прав доступа](../../std/737.md#3) — Диагностика v8cs:using-isinrole проверяет требование пункта 3 стандарта std737. Примечание: Следует учитывать исключения пунктов 4.1-4.2 стандарта.
