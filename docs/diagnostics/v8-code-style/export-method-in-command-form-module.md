...
- [#std544: Ограничения на использование экспортных процедур и функций](../../std/544.md#std544) — Диагностика v8cs:export-method-in-command-form-module проверяет требование пункта std544 стандарта std544.
- [#std630, п. 1.1: Правила создания модулей форм](../../std/630.md#11) — Диагностика v8cs:export-method-in-command-form-module проверяет требование пункта 1.1 стандарта std630.
