...
- [#std439, п. 1: Использование директив компиляции и инструкций препроцессора](../../std/439.md#1) — Диагностика v8cs:form-module-pragma проверяет требование пункта 1 стандарта std439.
