...
- [#std404, п. 1: Открытие форм](../../std/404.md#1) — Диагностика v8cs:use-non-recommended-method проверяет требование пункта 1 стандарта std404.
- [#std418: Ограничение на использование метода Сообщить](../../std/418.md#std418) — Диагностика v8cs:use-non-recommended-method проверяет требование пункта std418 стандарта std418.
- [#std643, п. 2.1: Работа в разных часовых поясах](../../std/643.md#21) — Диагностика v8cs:use-non-recommended-method проверяет требование пункта 2.1 стандарта std643.
