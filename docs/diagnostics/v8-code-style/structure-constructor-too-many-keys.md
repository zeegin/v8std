...
- [#std640, п. 6.2: Параметры процедур и функций](../../std/640.md#62) — Диагностика v8cs:structure-constructor-too-many-keys проверяет требование пункта 6.2 стандарта std640.
- [#std693, п. 1: Использование объектов типа Структура](../../std/693.md#1) — Пункт ограничивает конструктор структуры небольшим фиксированным набором свойств.
