...
- [#std492, п. 1: Обработчики событий модуля формы, подключаемые из кода](../../std/492.md#1) — Диагностика v8cs:module-attachable-event-handler-name проверяет требование пункта 1 стандарта std492.
