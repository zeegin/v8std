...
<a class="diagnostic-chip" href="../diagnostics/acc/125.md">acc:125</a>
<a class="diagnostic-chip" href="../diagnostics/bslls/CommonModuleInvalidType.md">bslls:CommonModuleInvalidType</a>
</div>
...
<div class="diagnostic-links" aria-label="Проверки">
<a class="diagnostic-chip" href="../diagnostics/acc/90.md">acc:90</a>
<a class="diagnostic-chip" href="../diagnostics/bslls/CommonModuleNameServerCall.md">bslls:CommonModuleNameServerCall</a>
<a class="diagnostic-chip" href="../diagnostics/v8-code-style/common-module-name-server-call.md">v8cs:common-module-name-server-call</a>
</div>
...
<div class="diagnostic-links" aria-label="Проверки">
<a class="diagnostic-chip" href="../diagnostics/acc/80.md">acc:80</a>
<a class="diagnostic-chip" href="../diagnostics/bslls/CommonModuleNameClient.md">bslls:CommonModuleNameClient</a>
<a class="diagnostic-chip" href="../diagnostics/v8-code-style/common-module-name-client.md">v8cs:common-module-name-client</a>
</div>
...
<a class="diagnostic-chip" href="../diagnostics/acc/547.md">acc:547</a>
<a class="diagnostic-chip" href="../diagnostics/bslls/CommonModuleNameClientServer.md">bslls:CommonModuleNameClientServer</a>
<a class="diagnostic-chip" href="../diagnostics/v8-code-style/common-module-name-client-server.md">v8cs:common-module-name-client-server</a>
</div>
...
<div class="diagnostic-links" aria-label="Проверки">
<a class="diagnostic-chip" href="../diagnostics/acc/73.md">acc:73</a>
<a class="diagnostic-chip" href="../diagnostics/bslls/CommonModuleNameWords.md">bslls:CommonModuleNameWords</a>
</div>
...
<!-- diagnostic-backlinks:start clause=3.2.1 -->
<div class="diagnostic-links" aria-label="Проверки">
<a class="diagnostic-chip" href="../diagnostics/acc/363.md">acc:363</a>
<a class="diagnostic-chip" href="../diagnostics/acc/83.md">acc:83</a>
<a class="diagnostic-chip" href="../diagnostics/bslls/CommonModuleNameGlobal.md">bslls:CommonModuleNameGlobal</a>
<a class="diagnostic-chip" href="../diagnostics/bslls/CommonModuleNameGlobalClient.md">bslls:CommonModuleNameGlobalClient</a>
<a class="diagnostic-chip" href="../diagnostics/v8-code-style/common-module-name-global.md">v8cs:common-module-name-global</a>
<a class="diagnostic-chip" href="../diagnostics/v8-code-style/common-module-name-global-client.md">v8cs:common-module-name-global-client</a>
</div>
<!-- diagnostic-backlinks:end clause=3.2.1 -->
...
<!-- diagnostic-backlinks:start clause=3.2.2 -->
<div class="diagnostic-links" aria-label="Проверки">
<a class="diagnostic-chip" href="../diagnostics/acc/84.md">acc:84</a>
<a class="diagnostic-chip" href="../diagnostics/bslls/CommonModuleNameFullAccess.md">bslls:CommonModuleNameFullAccess</a>
<a class="diagnostic-chip" href="../diagnostics/v8-code-style/common-module-name-full-access.md">v8cs:common-module-name-full-access</a>
</div>
<!-- diagnostic-backlinks:end clause=3.2.2 -->
...
<!-- diagnostic-backlinks:start clause=3.2.3 -->
<div class="diagnostic-links" aria-label="Проверки">
<a class="diagnostic-chip" href="../diagnostics/acc/85.md">acc:85</a>
<a class="diagnostic-chip" href="../diagnostics/bslls/CommonModuleNameCached.md">bslls:CommonModuleNameCached</a>
<a class="diagnostic-chip" href="../diagnostics/v8-code-style/common-module-name-cached.md">v8cs:common-module-name-cached</a>
<a class="diagnostic-chip" href="../diagnostics/v8-code-style/common-module-name-client-cached.md">v8cs:common-module-name-client-cached</a>
<a class="diagnostic-chip" href="../diagnostics/v8-code-style/common-module-name-server-call-cached.md">v8cs:common-module-name-server-call-cached</a>
</div>
<!-- diagnostic-backlinks:end clause=3.2.3 -->
...
- [Русская версия — ИТС](https://its.1c.ru/db/v8std#content:469)
- [English version — 1Ci Knowledge Base](https://kb.1ci.com/1C_Enterprise_Platform/Guides/Developer_Guides/1C_Enterprise_Development_Standards/Creating_and_modifying_metadata_objects/Configuration_operation_arrangement/Creating_common_modules/?language=en)
