...
<div class="v8std-home-page">
  ...
  <section class="v8std-home-section" id="diagnostics">
    <div class="v8std-home-section__header">
      <div>
        <h2>Проверки и автоматические исправления</h2>
        <p class="v8std-home-section__lead">
          Сайт полезен не только для чтения стандартов. Если вы пришли с предупреждением из
          линтера или хотите автоматически привести исходники к стандартам, здесь можно
          перейти от инструмента к правилу и решению.
        </p>
      </div>
    </div>
    <div class="v8std-home-card-grid v8std-home-card-grid--3">
      ...
      <a class="v8std-home-link-card" href="diagnostics/acc/">
        <p class="v8std-home-link-card__eyebrow">691 диагностика</p>
        <h3>АПК</h3>
      ...
      <a class="v8std-home-link-card" href="diagnostics/autoformat/">
        <p class="v8std-home-link-card__eyebrow">34 автозамены</p>
        <h3>Автоформатирование</h3>
        <p>Исправление кода, форм и метаданных по 15 стандартам с просмотром изменений.</p>
      </a>
    </div>
  </section>
