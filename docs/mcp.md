...
фрагментов исходного кода в `v8std.explain_snippet`.
...
`explain_snippet` ориентирован на фрагменты кода. Для обычной фразы вроде
`модальные окна` используйте `v8std.search`.
