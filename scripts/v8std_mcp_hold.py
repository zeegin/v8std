...
from v8std_mcp_snapshot_format import canonical_json, strict_json, validate_manifest, SnapshotError
...
class ReleaseControl:
    ...
    def read(self):
        from v8std_mcp_snapshots import _read_file, LoaderError
    ...
    def pin(self, archive):
        from v8std_mcp_snapshots import _file_lock
    ...
    def run(self):
        from v8std_mcp_snapshots import LoaderError
