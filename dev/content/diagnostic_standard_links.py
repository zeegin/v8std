...
from dev.content.diagnostic_articles import SourceCatalog, load_catalog, verify_checkout_revision
...
def main() -> int:
    ...
    parser.add_argument("--output", type=Path, default=Path("dev/content/data/diagnostic-standard-links.json"))
